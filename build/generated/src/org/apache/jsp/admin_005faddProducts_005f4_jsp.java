...
public final class admin_005faddProducts_005f4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (session) {
        product = (product.product) _jspx_page_context.getAttribute("product", PageContext.SESSION_SCOPE);
        if (product == null){
      ...
      synchronized (session) {
        productBean = (product.productBean) _jspx_page_context.getAttribute("productBean", PageContext.SESSION_SCOPE);
        if (productBean == null){
          productBean = new product.productBean();
          _jspx_page_context.setAttribute("productBean", productBean, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\n");
      out.write("         \n");
   ...
   /* if (productBean.getCompany() == null || 
      ...
      out.write("        var qty = $('#productQty');\n");
      out.write("        var price = $('#price');\n");
      out.write("        var summary = $('#summary');\n");
      out.write("        var next= $('.next');\n");
      out.write("        /*\n");
      out.write("        next.click (function (){\n");
      out.write("            if (qty.length < 2){\n");
      out.write("                qty.addClass('error');\n");
      out.write("                qty.css()\n");
      out.write("                 next.attr('disabled', true);\n");
      out.write("            }else {\n");
      out.write("                 qty.removeClass('error');\n");
      out.write("                 next.attr('disabled', false);\n");
      out.write("            }\n");
      out.write("            \n");
      out.write("            if (price.length < 2){\n");
      out.write("                price.addClass('error');\n");
      out.write("                 next.attr('disabled', true);\n");
      out.write("            }else {\n");
      out.write("                 price.removeClass('error');\n");
      out.write("                 next.attr('disabled', false);\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            if (summary.attr('value').length < 5){\n");
      out.write("                summary.addClass('error');\n");
      out.write("                 next.attr('disabled', true);\n");
      out.write("            }else {\n");
      out.write("                 summary.removeClass('error');\n");
      out.write("                 next.attr('disabled', false);\n");
      out.write("            }\n");
      out.write("        });*/\n");
      out.write("        \n");
      ...
      out.write("            if (isNaN(qty.attr('value'))){\n");
      out.write("                qty.addClass('error');\n");
      out.write("                qty.css('background', 'red');\n");
      out.write("                next.attr('disabled', true);\n");
      out.write("            }else {\n");
      out.write("                if (qty.attr('value')<0){\n");
      out.write("                    qty.addClass('error');\n");
      out.write("                    qty.css('background', 'red');\n");
      out.write("                    next.attr('disabled', true);\n");
      out.write("                }else {\n");
      ...
      out.write("            if (isNaN(price.attr('value'))){\n");
      out.write("                price.addClass('error');\n");
      out.write("                    price.css('background', 'red');\n");
      out.write("                next.attr('disabled', true);\n");
      out.write("            }else {\n");
      out.write("                if (price.attr('value')<0){\n");
      out.write("                    price.addClass('error');\n");
      out.write("                    price.css('background', 'red');\n");
      out.write("                    next.attr('disabled', true);\n");
      out.write("                }else {\n");
      ...
      out.print( productBean.getName() );
      out.write("\"/>\n");
      out.write("                    <input type=\"hidden\" name=\"tags\" value=\"");
      out.print( productBean.getTags() );
      out.write("\"/>\n");
      out.write("                    <input type=\"hidden\" name=\"page\" value=\"admin_addProduct_Insert.jsp\"/>\n");
      out.write("\n");
      out.write("                    <div class=\"grid_4\">\n");
      out.write("                        <h3>Product Price : Rs. </h3>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"grid_5\">\n");
      out.write("                        <input id=\"price\" type=\"number\" name= \"price\" min=\"1\" placeholder=\"eg.Rs 7899/-\" required/><br/>\n");
      out.write("                       \n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"clear\"></div><br/>\n");
      out.write("                    <div class=\"grid_4\">\n");
      out.write("                        <h3>Enter Quantity in Units</h3>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"grid_5\">\n");
      out.write("                        <input id=\"productQty\" type=\"number\" min=\"1\" name= \"productQty\"  placeholder=\"Quantity\" required/><br/>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"clear\"></div><br/>\n");
      out.write("                    <div class=\"grid_4\">\n");
      out.write("                        <h3>Enter Summary/Description</h3>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"grid_5\">\n");
      out.write("                        <textarea id=\"summary\" cols=\"40\" rows=\"20\" name=\"summary\" class=\"grid_6\" required></textarea>\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("                    <div class=\"clear\"></div><br/>\n");
      out.write("                    <div class=\"grid_7\">\n");
      out.write("                        <input id=\"buy\" class=\"next\" type=\"submit\" value=\"Next >\" disabled/>\n");
      out.write("                    </div>\n");
      out.write("                </form>\n");
      out.write("            </div>\n");
      out.write("\n");
