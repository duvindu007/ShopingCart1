...
public final class gCharts_005ftop10ProductsSold_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ORDER BY solds DESC 
               ...
               /* String top10products = "SELECT SUM( product_qty ) AS solds,  product_name "
                                +" FROM  sales "
                                +" GROUP BY  product_name "
                                +" ORDER BY solds DESC  "
                                +" LIMIT 0 , 10 ;";
...
/* out.print("([ "
      ...
      out.write("                                title: 'Top 10 products sold',\n");
      out.write("                                  vAxis: {title: \"Units Sold\"},\n");
      out.write("                                  hAxis: {title: \"Product Names\"}\n");
      out.write("                              };\n");
      out.write("\n");
      out.write("                              var chart = new google.visualization.LineChart(document.getElementById('chart_div_lineTop10Sold'));\n");
      out.write("                              chart.draw(data, options);\n");
      out.write("                            }\n");
      out.write("              \n");
      out.write("                </script>\n");
      out.write("                <div id=\"chart_div_lineTop10Sold\" style=\"width: 900px; height: 300px;\"></div>\n");
      out.write("                \n");
      out.write("            </div> \n");
      out.write("      \n");
      out.write("                \n");
