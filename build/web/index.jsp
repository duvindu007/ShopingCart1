...
<link rel="stylesheet" type="text/css" href="css_old/Styles.css"/>
        ...
        <link rel="stylesheet" href="css_old/slider.css">
            ...
            <div class="grid_16" style="padding-left: 20px; " id="slider">	
                <ul id="sliderContent">		
                    ...
                    <li class="sliderImage" style="display: none; ">
                        ...
                        <img src="images/banner/watchimage.jpg" width="900" height="300" /> 

                        <span class="top" style="display: none; ">

                            <strong>Watches......</strong>				

                            <br>High qaulity watches now available at our store. Login and add to cart to get it delivered to
                            your doorstep!
