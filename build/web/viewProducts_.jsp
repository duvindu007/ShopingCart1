...
<html>
    <head>
        ...
        <title>Online Electronic Shopping</title>
        <!--jsp:useBean class="product.product" id="productx" scope="session"!--><!--/jsp:useBean-->
                    ...
                    <%
                     ...
                     %>
                            ...
                            for (int i =0; i< subCat.size(); i++){
                                %>
                                <li><a href="scat=<%= subCat.get(i) %>"><%= subCat.get(i) %></a></li>      
                                <%
                            } subCat.clear(); %>
                                </ul>
                            </div>
                            ...
                            for (int i =0; i< Cat.size(); i++){
                                %>
                                <li><a href="viewProducts_.jsp?cat=<%= Cat.get(i) %>"><%= Cat.get(i) %></a></li>      
                                <%
                            } Cat.clear();
                            %>
                                </ul>
