        ...
        try {
           ...
           String sqlGetUsers = "SELECT * FROM  administrators;";
            ...
            while (rs.next()) {
                ...
                db_pass = rs.getString("password1");
                ...
                if (email.equals(db_email)) {
                    ...
                    if (pass.equals(db_pass)) {
                        ...
                        adminSession.setAttribute("admin", Administrator);
            ...
            message = "Something went wrong in Login process";
                    messageDetail = "Something went wrong in the process of login Please try after some time!";
