<%-- 
    ...
    Created on : Jun 4, 2017, 11:24:30 AM
    Author     : user
--%>
...
%>
        ...
        <div class="container_16">
            <% String tags = request.getParameter("tags");
                ...
                int quantity, addQuantity, updatedQuantity; 
                double productPrice;
...
UPDATE  `products` SET  `product-name` =  'XPS Seriator v2',
 ...
 `expenses_id` ,
    ...
    NULL ,  '123',  'ghth',  '456', NOW( )
                     ...
                     //   String sqlUpdateProduct =  " UPDATE  products  SET  product_name =  'update product'  WHERE  products.product_id =1 ";                
                       
                         String sqlUpdateProduct =  " UPDATE  products "
                        +" SET  product_name =  '"+productName+"',"
                        +" price =  '"+productPrice+"',"
                        +" tags =  '"+tags+"',"
                        +" product_qty =  '"+updatedQuantity+"',"
                        +" lastUpdated = getdate() ,"
                       ...
                       // String sqlUpdateExpenses = "INSERT INTO expenses ("
//+"  expenses_id , "
// +"   product_id ,"
// +"   product_name , "
 // +"  price , "
 ...
 //+"   ) "
 //+"   VALUES ( "
 //+"   NULL ,  '"+pid+"',  '"+productName+"',  '"+expenses+"', getdate() )";
            ...
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                ...
                <%
                    try {
                        ...
                        updatedQuantity = addQuantity;
                        if (updatedQuantity <= 0  || productPrice <= 0){
                            %>
