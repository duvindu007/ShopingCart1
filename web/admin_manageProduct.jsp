<%-- 
    ...
    Created on : Jun 4, 2017, 11:01:48 AM
    Author     : user
--%>
...
%>
        ...
        <div class="grid_2">
            <a href="admin_manageProduct.jsp?pid=<%=product_id%>"><img src="" /></a>
        </div>
            <div class="grid_6">
        ...
        <%
            ...
            String sqlFetchProductInfo = "SELECT * FROM  products p WHERE p.product_id = '"+productId+"' ";
            ...
            <form method="post" action="admin_changeProductInfo.jsp">
                ...
                <div class="grid_13"  style="padding: 10px; ">
                    <div class="grid_2">
                        Search Tags
                        <%
                        session.setAttribute("stags", searchTags);
                        %>
                    </div>
                    <div class="grid_5">
                    ...
                    <div class="grid_5">
                        <input type="text" name="quantity" value="<%=quantity%>" style="width: 75px;" disabled/>
                    </div>
                    <div class="clear"></div>
                    <div class="grid_2">
                        Update Product Quantity
                       <%
                        session.setAttribute("addQuantity",quantity );
                        %>
                    </div>
                    <div class="grid_5">
        ...
        <div class="grid_16" id="whiteBox">
            <br/>
            <h1 class="grid_7">Product Image Gallery </h1>
            <div class="grid_5">
